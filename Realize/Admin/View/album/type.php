...
<ul class="sortable">
  ...
  <li class="ui-state-default buttom">
      <div class="cate" id="app-2" title="双击编辑，拖拽排序">
           <div class="cate-check"><input type="checkbox" /></div>
           <div class="cate-id"><?php echo $val['id']?></div>
           <div class="cate-title"><?php echo $val['name']?></div>
           <div class="cate-del"><i class="fa fa-trash-o" id="del_<?php echo $val['id']?>"></i></div>
       </div>
  </li>
  <?php }?>
</ul>
