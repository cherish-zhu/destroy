...
<html>
    ...
    <h1>创建数据库</h1>
    <form action="/install/Install/step2" method="post">
        <div class="create-database">
            ...
            <div>
                <input type="text" name="db[]" value="destroy">
                <span>数据库名</span>
            </div>
            <div>
            ...
            <div>
                <input type="text" name="db[]" value="des_">
    ...
    <a class="btn btn-success btn-large" href="/install/Install/step1">上一步</a>
