...
<title>我的控制台</title>
<link type="text/css" rel="stylesheet" href="<?php echo css2("album2")?>" />
...
<script src="<?php echo url()?>webroot/public/JQuery-UI/jquery-ui-1.10.4.custom.min.js" type="text/javascript"></script>
<script src="<?php echo url()?>webroot/public/JQuery-extend/AjaxPage.jquery.js" type="text/javascript"></script>
