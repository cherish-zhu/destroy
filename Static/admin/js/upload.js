...
//=============================多文件上传===================================================
      $('#uploadify').uploadify({
				...
				formData     : {
					...
					token     :  $("#album_id").text(),//< ?php echo md5('unique_salt' . $timestamp);?>
				},
				 ...
				 itemTemplate : ' <li><img alt="150x150" src="/Data/Uploads/thumb-5.jpg" /><div id="${fileID}" class="uploadify-queue-item"><div class="uploadify-progress-bar"></div></li>',
			   ...
			   onUploadSuccess : function(file, data, response) {//上传成功
				     ...
				     $(".pic_box img[src$='thumb-5.jpg']:eq(0)").attr("src",data.thumb);
               }
      });
      ...
      box.addEventListener("drop",function(e){
			...
			$.each(fileList,function(i,e){
				...
				var uploadUrl = baseURL+"/upload/?aid="+aid;
